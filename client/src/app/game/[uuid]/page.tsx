  ...
  return (
    <main>
      <div className={styles.page}>
        ...
        <Typography variant="subheader" className={styles.timer} bold>{formattedTimer}</Typography>
        </div>
        <Studio user={user} uuid={uuid} timer={timer} socket={socket.current || undefined}/>
      </div>
    </main>
  );
}
